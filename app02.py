...
calc1c = Calculator(policy=pol1, records=recs, corprecords=crecs1, verbose=False)
calc1p = Calculator(policy=pol1, records=recs, corprecords=crecs2, verbose=False)
calc2c = Calculator(policy=pol2, records=recs, corprecords=crecs1, verbose=False)
calc2p = Calculator(policy=pol2, records=recs, corprecords=crecs2, verbose=False)
...
for year in range(2017, 2022):
    ...
    print(f'************* Year  {year}  *************')
    #print('*************Year  ' + str(year) + '   *************')
    print('GTI before loss, baseline, cross: ' + str(sum(AggIncCB * wgtCB) / 10**7))
    ...
    print('\n')
    print('GTI before loss, baseline, panel: ' + str(sum(AggIncPB * wgtPB) / 10**7))
